...
Base.@kwdef mutable struct MeasurementData
    ...
    """
    data_type::Union{String,Nothing} = nothing

    """
    Whether or not the data has been generated by simulation. Default
    is False.
    """
    is_simulated::Union{Bool,Nothing} = nothing
...
"""
Base.@kwdef mutable struct ModifierElement
    """
...
Base.@kwdef mutable struct Reaction
    ...
    influence it.
    """
    modifiers::Union{Vector{
            ModifierElement},Nothing} = nothing
...
Base.@kwdef mutable struct SmallMolecule
    ...
    """
    synonymous_names::Union{Vector{String},Nothing} = nothing
